 ...
 * ========================================================================== *
 * Modifications:
 * - This file has been slightly modified as to not collide with the scrooge
 *   namespace.
 */
...
object DittoGeneratorFactory extends GeneratorFactory {
  //override the default scrooge scala backend
  val language = "dittoscala"
  val handlebarLoader = new HandlebarLoader("/dittoscalagen/", ".scala")
  def apply(
             doc: ResolvedDocument,
             defaultNamespace: String,
             experimentFlags: Seq[String]
           ): Generator = {
    println("IM LOADED GUYS")
    new DittoGenerator(
      doc,
      defaultNamespace,
      experimentFlags,
